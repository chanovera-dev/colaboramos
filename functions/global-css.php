    ...
    ?>
        <style>
            ...
            *,:before,:after{box-sizing:border-box;margin:0;}
            ...
            body{font-size:16px;font-weight:400;line-height:1.7;text-align:left;background:linear-gradient(mistyrose, transparent), linear-gradient(to top left, peachpuff, transparent), linear-gradient(to top right, peachpuff, transparent);background-blend-mode:screen;}
