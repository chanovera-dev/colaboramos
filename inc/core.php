...
function setup_colaboramos() {
    ...
    register_nav_menus(
        array(
            'primary'      => __( 'Desktop Header Menu', 'colaboramos' ),
            'social'       => __( 'Social Menu', 'colaboramos' ),
            'others'       => __( 'Contact Footer Menu', 'colaboramos' ),
        )
    );
...
add_action( 'after_setup_theme', 'setup_colaboramos' );
