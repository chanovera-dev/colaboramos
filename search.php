...
<main id="main" class="site-main" role="main">
    ...
    <header class="block post-header">
            <div class="content">
                <h1 class="page-title"><?php echo esc_html__('Búsqueda de "', 'colaboramos'); echo the_search_query(); echo esc_html__('"', 'colaboramos') ?></h1>
            </div>
    </header>
        ...
        <div class="content">
            <?php
                ...
                if ( have_posts() ) {
                    ...
                    echo '<p>' . esc_html_e( 'No se han encontrado artículos', 'colaboramos' ) . '</p>';
